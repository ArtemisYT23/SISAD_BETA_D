...
import { setOpenModalRestored } from "../../../../redux/states/ActionCore";
...
const ActiveMenu = () => {
  ...
  const handleClick = () => {
    dispatch(setOpenModalRestored(!isOpenRestored));
  };
    ...
    <ContainerBreak>
      <Tooltip title="Menu">
        <Break onClick={() => handleClick()}>
          <ImagenIcon isOpen={isOpenRestored} src={IconDer} alt="Cargando" />
        </Break>
      </Tooltip>
    </ContainerBreak>
  );
