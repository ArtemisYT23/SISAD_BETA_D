...
import { setOpenModalSecurity } from "../../../../redux/states/ActionCore";
...
const ActiveMenu = () => {
  ...
  const handleClick = () => {
    dispatch(setOpenModalSecurity(!isOpenSecurity));
  };
    ...
    <ContainerBreak>
      <Tooltip title="Menu">
        <Break onClick={() => handleClick()}>
          <ImagenIcon isOpen={isOpenSecurity} src={IconDer} alt="Cargando" />
        </Break>
      </Tooltip>
    </ContainerBreak>
  );
